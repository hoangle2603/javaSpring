			...
			<div class="well np">
				<div id="myCarousel" class="carousel slide homCar">
					<div class="carousel-inner">
						<div class="item">
							<img style="width: 100%"
								src="<c:url value="/assets/user/img/bootstrap_free-ecommerce.png"></c:url> "
								alt="bootstrap ecommerce templates">
						...
						<div class="item">
							<img style="width: 100%"
								src="<c:url value="/assets/user/img/carousel1.png"></c:url> "
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item active">
							<img style="width: 100%"
								src="<c:url value="/assets/user/img/carousel3.png"></c:url> "
								alt="bootstrap ecommerce templates">
							<div class="carousel-caption">
						...
						<div class="item">
							<img style="width: 100%"
								src="<c:url value="/assets/user/img/bootstrap-templates.png"></c:url> "
									...
									<li class="span3">
										<div class="thumbnail">
											<a class="zoomTool" href="product_details.html"
												...
												src="<c:url value="/assets/user//img/s.png"></c:url> "
												alt=""></a>
										</div>
									</li>
								</ul>
